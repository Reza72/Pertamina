...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void sendLogin() {
        ...
        StringRequest loginRequest = new StringRequest(Request.Method.POST, Server.LOGIN_URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Server.KEY_EMAIL, mEmailView.getText().toString());
                params.put(Server.KEY_PASSWORD, mPasswordView.getText().toString());
